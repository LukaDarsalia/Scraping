...
class PipelineRunner:
    ...
    def dynamic_import(self, module_name: str, class_name: str):
        """
    ...
    def get_retry_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def run_crawler(self, website, output_path, config):
        ...
        retry_config = self.get_retry_config(config)
